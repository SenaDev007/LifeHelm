...
export default function AccessibleVentePage() {
    ...
    <div style={{ padding: 16, maxWidth: 560, margin: "0 auto" }}>
      ...
      <div style={{ marginTop: 20 }}>
        ...
        <label style={{ display: "grid", gap: 8 }}>
          <span style={{ fontSize: 14, opacity: 0.85 }}>Montant de recette du jour (FCFA)</span>
          <input
            inputMode="numeric"
            value={amount}
        ...
        <button
          ...
          onClick={async () => {
            ...
            try {
              ...
              setAmount(String(Math.max(0, parsed - parsed + 0))); // remise à zéro UI (simple)
